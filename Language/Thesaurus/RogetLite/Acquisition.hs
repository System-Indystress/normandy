...
## Acquisition
noun:
* acquisition, gaining, obtainment, procuration, procurement, purchase, descent, inheritance, gift
*recovery, retrieval, revendication, replevin, redemption, salvage, trover
*find, trouvaille, foundling
*gain, thrift, money-making, money grubbing, lucre, filthy lucre, pelf, loaves and fishes, the main chance, emolument
*profit, earnings, winnings, innings, pickings, net profit, avails, income  , proceeds, produce, product, outcome, output, return, fruit, crop, harvest, second crop, aftermath, benefit
*sweepstakes, trick, prize, pool, pot, wealth
*fraudulent acquisition subreption, obreption, stealing
verb:
*acquire, get, gain, win, earn, obtain, procure, gather, collect  , pick, pickup, glean
