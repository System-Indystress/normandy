...
*almanac
 army list, clergy list, civil service list, navy list, Almanach de Gotha, cadaster, card index, card file, rolodex, dictionary, thesaurus, Lloyd's register, nautical almanac, who's who, Guinness Book of World Records
*roll
 check roll, checker roll, bead roll, muster roll, muster book, roster, lineup, panel, cartulary, diptych
adj:
* cadastral
|]
