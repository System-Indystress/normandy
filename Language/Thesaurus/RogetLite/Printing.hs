...
*print
 letterpress, text, context, note, page, column
*typography
 stereotype, electrotype, aprotype, type, black letter, font, fount, pi, pie, capitals  , brevier, bourgeois, pica
...
*folio  
 copy, impression, pull, proof, revise, author's proof, galley proof, press proof, press revise
*printer
 compositor, reader, printer's devil copyholder
verb:
* print
 compose, put to press, go to press, pass through the press, see through the press, publish , bring out, appear in print, rush into print, distribute, make up, mortise, offset, overrun, rout
adj:
* printed
 in type, typographical, solid in galleys
|]
